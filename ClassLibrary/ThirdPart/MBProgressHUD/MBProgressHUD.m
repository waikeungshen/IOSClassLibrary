...
static MBProgressHUD* last_hub = nil;
...
+ (MB_INSTANCETYPE)showHUDAddedTo:(UIView *)view Frame:(CGRect)frame animated:(BOOL)animated {
...
- (NSArray *)observableKeypaths {
	return [NSArray arrayWithObjects:@"labelText", @"mode", @"customView", @"labelText", @"labelFont",
...
- (void)registerForNotifications {
    ...
    [nc addObserver:self selector:@selector(statuBarFrameChange:)
...
- (void)statuBarFrameChange:(NSNotification*)notification {
